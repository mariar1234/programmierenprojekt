...
def add_item(entry: Entry, listbox: Listbox):
    ...
    with open(r"C:\Users\Philipp\Python\Tasks.txt") as tasks_list_file:
...
root = Tk()
root.title('Haas To-Do List')
root.geometry('300x400')
root.resizable(0, 0)
root.config(bg="Darkgrey")

# Heading Label
Label(root, text='Haas To-Do List', bg='Darkgrey', font=("Comic Sans MS", 15), wraplength=300).place(
    x=35, y=0)

# Listbox with all the tasks with a Scrollbar
tasks = Listbox(root, selectbackground='Grey', bg='White', font=('Helvetica', 12), height=12, width=25)
...
with open(r"C:\Users\Philipp\Python\Tasks.txt") as tasks_list:
